...
class ParallelBitonicSortTest {
    private final ParallelBitonicSort bitonicSort = new ParallelBitonicSort();

    @Test
    public void handlesNullInput() throws InterruptedException {
